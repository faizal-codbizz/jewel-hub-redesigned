      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="col-span-1 md:col-span-3">
            <h5 className="font-semibold text-slate-900 mb-3 sm:mb-4 text-center md:text-left">Contact Us</h5>
            <div className="space-y-4 font-light">
              <a href="mailto:hello@jewelmounts.com" className="flex items-center gap-3 justify-center md:justify-start group hover:text-[#00468B] transition-colors duration-300">
                <Mail className="w-5 h-5 text-[#00468B] flex-shrink-0" />
                <span className="text-sm sm:text-base text-center md:text-left">hello@jewelmounts.com</span>
              </a>
              <a href="tel:+442070180190" className="flex items-center gap-3 justify-center md:justify-start group hover:text-[#00468B] transition-colors duration-300">
                <Phone className="w-5 h-5 text-[#00468B] flex-shrink-0" />
                <span className="text-sm sm:text-base text-center md:text-left">+44 20 7018 0190</span>
              </a>
              <div className="flex items-start gap-3 justify-center md:justify-start group hover:text-[#00468B] transition-colors duration-300">
                <Home className="w-5 h-5 text-[#00468B] flex-shrink-0 mt-1" />
                <span className="text-sm sm:text-base text-center md:text-left">Suite 49, New House 67-68 Hatton Garden London EC1N8JY United Kingdom</span>
              </div>
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div className="col-span-1 md:col-span-3">
            <h5 className="font-semibold text-slate-900 mb-3 sm:mb-4 text-center md:text-left">Quick Links</h5>
            <ul className="space-y-3 font-light text-center md:text-left">
              {QUICK_LINKS.map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="group flex items-center gap-2 justify-center md:justify-start hover:text-[#00468B] text-sm transition-all duration-300">
          ...
          <div className="col-span-1 md:col-span-2">
            <h5 className="font-semibold text-slate-900 mb-3 sm:mb-4 text-center md:text-left">Download Our App</h5>
            <div className="flex flex-col sm:flex-row md:flex-col gap-3 items-stretch sm:items-center md:items-start w-full">
              {/* App Store Button */}
              <a
                href="https://apps.apple.com/in/app/jewel-mounts/id6451834732"
                target="_blank"
                className="group inline-flex items-center justify-center gap-3 w-42 max-w-xs sm:max-w-sm h-12 sm:h-14 rounded-xl bg-black text-white px-4 transition-all duration-300 hover:bg-zinc-900"
              >
                <span className="flex items-center justify-center w-7 h-7">
                  <img src={appleLogo} alt="Apple Logo" className="invert" />
                </span>
                <span className="flex flex-col leading-tighter text-left">
