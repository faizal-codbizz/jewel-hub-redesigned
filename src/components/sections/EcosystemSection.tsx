      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
          ...
          <motion.div 
            ...
            className="bg-white rounded-[1.5rem] sm:rounded-[2rem] border border-slate-200 p-6 sm:p-8 md:p-10 lg:p-12 hover:border-[#00468B]/20 hover:shadow-[0_20px_50px_rgba(0,70,139,0.08)] transition-all duration-300 group relative overflow-hidden will-change-transform"
          >
            {/* Decorative corner gradient*/}
            <div className="absolute -top-20 -right-20 w-40 h-40 rounded-full bg-gradient-to-br from-[#00468B]/10 to-transparent blur-2xl group-hover:scale-150 transition-transform duration-500 will-change-transform" />
            
            <div className="relative z-10">
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#00468B]/10 to-[#00468B]/5 flex items-center justify-center mb-6 sm:mb-8 group-hover:scale-110 transition-transform duration-200 will-change-transform">
              ...
              <ul className="space-y-4 mb-0">
                {buyerBenefits.map((benefit, i) => (
                  <motion.li 
                    ...
                    className="flex items-center gap-3 text-slate-700 will-change-transform"
                  >
          ...
          <motion.div 
            ...
            className="bg-gradient-to-br from-[#00468B] to-[#003366] rounded-[1.5rem] sm:rounded-[2rem] p-6 sm:p-8 md:p-10 lg:p-12 hover:shadow-[0_20px_50px_rgba(0,70,139,0.25)] transition-all duration-300 group relative overflow-hidden will-change-transform"
          >
            {/* Decorative elements - optimized */}
            <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:32px_32px] pointer-events-none" />
            <div className="absolute -bottom-20 -left-20 w-40 h-40 rounded-full bg-white/5 blur-2xl group-hover:scale-150 transition-transform duration-500 will-change-transform" />
            
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/10 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:bg-white/15 transition-all duration-200 will-change-transform">
              ...
              <ul className="space-y-4 mb-0">
                {sellerBenefits.map((benefit, i) => (
                  <motion.li 
                    ...
                    className="flex items-center gap-3 text-white/90 will-change-transform"
                  >
